...
class Ui_WelcomeScreen(object):
    ...
    def setupUi(self, Form):
        ...
        self.lbl_btn_start.setPixmap(QtGui.QPixmap("images/button/full_check_in-01.png"))
        ...
        self.lbl_btn_start2.setPixmap(QtGui.QPixmap("images/button/full_check_in-01.png"))
        ...
        self.btn_register.setPixmap(QtGui.QPixmap("images/button/full_check_in-01.png"))
